...
/* 
The renderer uses Vite support for importing SASS/SCSS as a JS pseudo-module (https://vitejs.dev/guide/features#css)

This import creates a variable 'styles' containing the compiled CSS created from ipuzzler.scss
*/
import styles from './ipuzzler.scss';
